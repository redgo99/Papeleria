...
<body>
    ...
    <form action="procesar_usuario.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="cedula" name="cedula" value="<?php echo $cedula; ?>" required><br><br>
        ...
        <input type="password" id="contraseña" name="contraseña"><?php echo $contraseña; ?></textarea><br><br>

        <label for="celular">Celular:</label><br>
        <input type="number" id="celular" name="celular" step="0.01" value="<?php echo $celular; ?>" required><br><br>

        <label for="direccion">direccion:</label><br>
        <input type="text" id="direccion" name="direccion" value="<?php echo $direccion; ?>"><br><br>

        <label for="rol">Rol:</label><br>
        <input type="text" id="rol" name="rol" value="<?php echo $rol; ?>"><br><br>

        <input type="submit" value="<?php echo isset($_GET['id']) ? 'Actualizar usuario' : 'Agregar usuario'; ?>">
    </form>

    <a href="../usuarios.php">Volver al listado de usuarios</a>
</body>
