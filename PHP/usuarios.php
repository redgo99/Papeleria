...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row['rol'] . "</td>";
            echo "<td>
                    <a id='bt' class='acep' href='funcionesUsuario/formularioUsuarios.php?id=" . $row['cedula'] . "'>Editar</a> | 
                    <a id='bt' class='del' href='funcionesUsuario/eliminar_usuario.php?id=" . $row['cedula'] . "' onclick='return confirm(\"¿Estás seguro?\")'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }
