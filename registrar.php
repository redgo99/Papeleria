...
<body>
  ...
  <div id="cont">
    ...
    <br> </br>
    <input type="text" id="nombre" maxlength=25 name="nombre" placeholder="Nombre usuario"  required />
    ...
    <br> </br>
    <input type="text" id="direccion" maxlength=25 name="direccion" placeholder="Direccion" required />
    ...
    <div class="roles">
      ...
      <label for="admin">  <input type="radio" id="admin" name="rol" value="Administrador" required />  Administrador</label>

      <p>|</p>
    
      <label for="cliente"><input type="radio" id="cliente" name="rol" value="cliente" checked required />  Cliente</label>
    </div>

    <br> </br>
    <button type="button" id="enviar">Crear</button>
    <br> </br>
    <button type="button" id="ini"><a href="index.php">Volver</a></button>
  </div>
